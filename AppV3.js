...
//        	 Age = Age;
	...
	con.query("TRUNCATE TABLE entries", function(err,res){
 	...
 	console.error(res);	
   	...
   	con.query("INSERT INTO entries(location, ethnicity, gender, age) VALUES ?", [entry], function(err,res){
   		  if(err){ console.error(err);
   		  return;}
   		//  console.log('Last insert ID:', res.insertId);
   	console.error(res);	
...
//   		con.query("TRUNCATE TABLE end_res", function(err,res){
//   		  if(err){ console.error(err);
//   		  return;}
//   		//  console.log('Last insert ID:', res.insertId);
//   	console.error(res);	
...
//   		
   ...
   con.query("SELECT * FROM end_res", function(err,res){
    		if(err){ console.error(err);
    	  return;}
     		//  console.log('Last insert ID:', res.insertId);
     console.error(res);
...
server.listen(1197);
console.log("server listening on 1197");
